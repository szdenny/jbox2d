 ...
 */
public class LoadRUBE_truck extends TestbedTest {
  ...
  public boolean isSaveLoadEnabled() {
	...
	public void initTest(boolean argDeserialized) {
	  ...
	  World world = json.readFromFile("truck.json", errorMsg);
	  if ( null != world ) {
		  m_world = world;
		  ...
		  wheelBodies = json.getBodiesByName("truckwheel");
	  }
	  else 
